...
export const RAINY_NIGHT_FLOWER_SHOP: DialogueDefinition = {
  ...
  nodes: {
    ...
    start: {
      ...
      id: 'start',
      speaker: 'narrator',
      text: 'The flower shop light is still on. Through the rain-streaked window, you can see a figure inside.',
      typeSpeed: 0.7,
      next: 'approach',
    },
    ...
    rika_notice: {
      ...
      speaker: 'rika',
      speakerName: 'Rika',
      text: 'Oh... you\'re still out? In this rain?',
      emotion: 'surprised',
      typeSpeed: 0.8,
      next: 'rika_pause',
    },
    ...
    rika_question: {
      ...
      speaker: 'rika',
      speakerName: 'Rika',
      text: 'Have you ever felt tired of living the same day over and over?',
      emotion: 'melancholic',
      typeSpeed: 0.6,
      next: 'player_choice',
    },
    ...
    player_choice: {
      ...
      choices: [
        {
          text: 'Yeah... sometimes it feels like nothing changes.',
          choiceId: 'empathize',
        ...
        {
          text: 'I think every day has something small worth noticing.',
          choiceId: 'hopeful',
    ...
    rika_empathy_response: {
      ...
      speaker: 'rika',
      speakerName: 'Rika',
      text: 'Right? Like... you wake up, open the shop, close the shop. And then what?',
      emotion: 'sad',
      typeSpeed: 0.7,
      next: 'rika_smile',
    },
    ...
    rika_hopeful_response: {
      ...
      speaker: 'rika',
      speakerName: 'Rika',
      text: '...Something small worth noticing.',
      emotion: 'thoughtful',
      typeSpeed: 0.6,
      next: 'rika_hopeful_2',
    },
    ...
    rika_hopeful_2: {
      ...
      speaker: 'rika',
      speakerName: 'Rika',
      text: 'I like that. Maybe I just forgot how to look.',
    ...
    rika_curious_response: {
      ...
      speaker: 'rika',
      speakerName: 'Rika',
      text: 'I don\'t know. Rainy nights make me think too much, I guess.',
      emotion: 'embarrassed',
      typeSpeed: 0.7,
      next: 'rika_smile',
    },
    ...
    rika_smile: {
      ...
      speaker: 'rika',
      speakerName: 'Rika',
      text: 'Sorry. That was weird to say to someone I barely know.',
      emotion: 'embarrassed',
      typeSpeed: 0.8,
      next: 'rika_thanks',
    },
    ...
    rika_thanks: {
      ...
      speaker: 'rika',
      speakerName: 'Rika',
      text: 'But... thanks for listening. It\'s nice to not be alone with my thoughts for once.',
      emotion: 'warm',
      typeSpeed: 0.7,
      next: 'closing_action',
    },
    ...
    closing_action: {
      ...
      actions: [
        { type: 'add_trust', npcId: 'rika', amount: 10 },
        {
          ...
          description: 'Rika opened up about feeling stuck in routine on a rainy night.',
          tags: ['night', 'rain', 'vulnerable', 'shared_vulnerable_moment'],
        },
    ...
    narrator_close: {
      ...
      id: 'narrator_close',
      speaker: 'narrator',
      text: 'The rain continues to fall. But somehow, the night feels a little warmer.',
      typeSpeed: 0.6,
